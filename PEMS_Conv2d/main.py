...
training_group.add_argument('-ts', '--train_set_size', default=70, type=int, help='training set size')
training_group.add_argument('-vs', '--valid_set_size', default=30, type=int, help='validation set size')
